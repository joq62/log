...
no_ebin_commit:
	...
	rm -rf log resource_discovery etcd adder;
	rm -rf test_ebin;
...
eunit: 
	...
	#INFO: Creat test application adder
	rm -rf adder;
	git clone https://github.com/joq62/adder.git adder;
	erlc -I adder/include -I include -I /home/joq62/erlang/include -o test_ebin adder/src/*.erl;
	cp adder/src/adder.app.src test_ebin/adder.app;
	#INFO: Compile application
	mkdir ebin;		
	rebar3 compile;	
	cp _build/default/lib/*/ebin/* ebin;
